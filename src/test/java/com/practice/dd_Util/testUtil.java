...
public static ExcelReader excel=new ExcelReader(System.getProperty("user.dir")+"\\src\\test\\java\\com\\practice\\dd_properties\\Data_Assig1.xlsx");


public static boolean isExecutable(String testcaseid)
{  
	...
	{
		if(excel.getCellData(sheetName,"tcid", rowNum).equals(testcaseid))
		 {
...
public static Object[][] getData(String sheetName)
{
	if(excel==null)
	{
		excel=new ExcelReader(System.getProperty("user.dir")+"\\src\\test\\java\\com\\practice\\dd_properties\\Data_Assig1.xlsx");
